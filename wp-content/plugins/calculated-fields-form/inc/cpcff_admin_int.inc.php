			...
			function calculatedFieldsFormReady()
			{
				...
				jQuery("#c0").click( function(){
				  if(confirm("<?php _e( 'These features aren\'t available in this version. Do you want to open the plugin\'s page to check other versions?', 'calculated-fields-form' ); ?>"))
					  document.location = 'http://cff.dwbooster.com/';
				} );
 ...
 <p class="submit">
  ...
  <div class="inside">
     <table class="form-table">
        ...
        <?php _e( '- For general CSS styles modifications to the form and samples <a href="http://cff.dwbooster.com/faq#q82" target="_blank">check this FAQ</a>.', 'calculated-fields-form' ); ?>
        </tr>
        <?php
...
<div id="metabox_basic_settings" class="postbox" >
 ...
 [<a href="http://cff.dwbooster.com/customization" target="_blank"><?php _e( 'Request Custom Modifications', 'calculated-fields-form' ); ?></a>] | [<a href="https://wordpress.org/support/plugin/calculated-fields-form#new-post" target="_blank"><?php _e( 'Help', 'calculated-fields-form' ); ?></a>]

 <br /><br /><br />

 <h3><?php _e( 'The following settings are available only in the <a href="http://cff.dwbooster.com/">pro version</a>', 'calculated-fields-form' ); ?>:</h3>
